...
{
    public class BandProfile : BaseProfile
    {
        public BandProfile()
        {
            CreateMap<Band, BandViewModel>()
                 .ForMember(dst => dst.FormationDate, opt => opt.MapFrom(src => src.StartActivityDate))
                 .ForMember(dst => dst.DisbandDate, opt => opt.MapFrom(src => MapDate(src.EndActivityDate)))
            ...
            CreateMap<UpsertBandCommand, Band>()
                 ...
                 .ForMember(dst => dst.EndActivityDate, opt => opt.MapFrom(src => MapDate(src.DisbandDate)))
